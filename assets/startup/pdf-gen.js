...
const IS_PROD = 'production' === 'production'
const GENERATE_PDF_LOCALLY = 'true' === 'true' || false
...
const BASEURL = 'bible-reading-plan'.replace('/', '')
...
const S3_PDF_FOLDER = 'RiverlifeSG/bible-reading-plan'.replace(/\//g, '-') + (IS_PROD ? '' : '-staging')
