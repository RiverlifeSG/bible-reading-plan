    ...
    */
    ...
    editButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            var repoUrl = 'https://github.com/RiverlifeSG/bible-reading-plan' + '/blob/master/'
    ...
    printButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            ...
            var replacedRepoName = 'RiverlifeSG/bible-reading-plan'.replace(/\//g, '-') + (isProd ? '' : '-staging')
            var pdfUrl = 'true' === 'true' ?
                '/bible-reading-plan/assets/pdfs' :
